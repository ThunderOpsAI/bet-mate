  ...
  return (
    <div>
      ...
      <div className="disclaimer">
        <strong>Disclaimer:</strong> {RECOMMENDATION_DISCLAIMER} Predictions are generated by machine learning models and are not guarantees. If you need help, visit <a href="https://www.gamblinghelponline.org.au/" target="_blank" rel="noopener noreferrer" style={{ color: "var(--yellow)", textDecoration: "underline" }}>Gambling Help Online</a>.
      </div>
    </div>
  );
}
